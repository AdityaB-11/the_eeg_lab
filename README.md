# The EEG Lab: Comparative Analysis and Novel Development of Self-Supervised Foundation Models for Universal EEG Representation and Disease Prediction

## Overview
This project provides a modern web-based platform for EEG research, enabling:
- **Model Testing**: Evaluate and compare available foundation models on EEG datasets.
- **Accuracy Checking**: Visualize and analyze model performance metrics.
- **Novel Model Training**: Train new self-supervised foundation models for EEG representation and disease prediction.
- **Jupyter Notebook Integration**: Launch and manage notebooks for custom analysis and model development.
- **Data Repository**: Organize, upload, and manage EEG datasets and training data.
## Features
- Modular Flask backend with RESTful APIs
- Modern Bootstrap 5 UI with interactive charts (Chart.js)
- Self-supervised learning: contrastive, masked, BYOL, transformer-based models
- PyTorch Lightning training utilities and model comparison
- Jupyter notebook integration for research workflows
- Data upload, management, and repository
...
├── /data/                  # EEG datasets and uploads
├── /models/                # Saved models
├── /results/               # Model results and logs
├── /notebooks/             # Jupyter notebooks
├── /src/models/
│   ├── foundation_models.py  # Self-supervised EEG models
│   └── training.py           # Training/comparison utilities
└── README.md
```
## Getting Started
...
- Launch or create notebooks from the web UI (Notebooks tab)
- Example notebook: `notebooks/EEG_Analysis_Template.ipynb`
- Use notebooks for custom model development, data exploration, and analysis
## Model Development
- Implement or extend models in `src/models/foundation_models.py`
- Use `src/models/training.py` for training, evaluation, and comparison
- All major self-supervised learning paradigms supported (contrastive, masked, BYOL, transformer)
## Data Management
- Upload datasets via the web UI (Datasets tab)
- All uploaded data is stored in `/data/`
